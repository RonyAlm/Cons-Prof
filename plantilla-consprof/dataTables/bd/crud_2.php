...
$user_id = (isset($_POST['id_cliente'])) ? $_POST['id_cliente'] : '';
...
switch($opcion){
    ...
    case 4:    
        ...
        $consulta = "SELECT turnos.id, cliente.id_cliente, persona.nombre_persona, turnos.start , turnos.end, consulta.descripcion_consulta, tipo_consulta.descripcio_tipo_consulta, consulta.precio_consulta 
