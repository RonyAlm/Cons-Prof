<?php
  ...
  if (isset($_POST['agregar_consulta'])) {
    ...
    $precio= $_POST['precio'];
       ...
       $sql= "INSERT INTO consulta (precio_consulta, descripcion_consulta, rela_profesional,rela_tipo_consulta)
              VALUES(:precio_consulta, :descripcion_consulta, :rela_profesional, :rela_tipo_consulta)";

        $resultado= $base_de_datos->prepare($sql);

        $resultado->execute(array(':precio_consulta'=>$precio,':descripcion_consulta'=>$descripcion_consulta,
                                   ':rela_profesional'=>$id_user, ':rela_tipo_consulta'=>$tipo_consulta));
