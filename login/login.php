<?php
    ...
    if(!empty($_GET)){ //Validar GET
        $tipo = $_GET['tipo'];
        $sql = "SELECT id, tipo FROM tipo_usuario where id=$tipo ORDER BY tipo ";
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        ...
                                        <h3 class="text-center font-weight-light my-4">Acceso <?php echo $row['tipo'] ?> | Iniciar Sesión</h3>
                                    ...
                                    <div class="card-footer text-center">
                                        <form action="registro.php" method="get">
                                             <label for="tipo">No tiene una cuenta?</label>
                                             <button  name="tipo" style=" border: none; background-color: transparent; color: white;" type="submit" value="<?php echo $tipo; ?>"> Registrate aquí!</button>
                                        </form>
